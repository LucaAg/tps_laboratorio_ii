...
{
    public class MiExcepcionPersonaNula : Exception
    {
        ...
        public MiExcepcionPersonaNula(string mensaje, string clase, string metodo) : this(mensaje, clase, metodo, null)
        {
        }
        /// <summary>
        ...
        public MiExcepcionPersonaNula(string mensaje, string clase, string metodo, Exception innerException)
        ...
        public override string ToString()
        {
            ...
            MiExcepcionPersonaNula miException = this;
            while (miException.InnerException != null)
            {
                miException = (MiExcepcionPersonaNula)miException.InnerException;
