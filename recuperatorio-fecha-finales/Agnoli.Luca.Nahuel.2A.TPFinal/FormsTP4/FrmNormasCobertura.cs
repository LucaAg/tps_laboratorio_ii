...
namespace FormsTP4
{
    ...
    {
        private PuntoTxt<string> archivoSistAtencion;
        private string datosTotalesCobertura;
        private string rutaImprimir;
        private string rutaSistAtencion;
        private string rutaOrientacion;
        private string rutaAtencionAmbulatoria;
        private string rutaMedicamentos;
        private string rutaInternacion;
        /// <summary>
