...
{
    public class ExcepcionPersonaNula : Exception
    {
        ...
        public ExcepcionPersonaNula(string mensaje, string clase, string metodo) : this(mensaje, clase, metodo, null)
        {
        }
        /// <summary>
        ...
        public ExcepcionPersonaNula(string mensaje, string clase, string metodo, Exception innerException)
        ...
        public override string ToString()
        {
            ...
            ExcepcionPersonaNula miException = this;
            while (miException.InnerException != null)
            {
                miException = (ExcepcionPersonaNula)miException.InnerException;
