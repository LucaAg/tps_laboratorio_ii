...
{
    public class ExcepcionCasillerosEnBlanco : Exception
    {
        ...
        public ExcepcionCasillerosEnBlanco(string mensaje, string clase, string metodo) : this(mensaje, clase, metodo, null)
        {
        }
        /// <summary>
        ...
        public ExcepcionCasillerosEnBlanco(string mensaje, string clase, string metodo, Exception innerException)
        ...
        public override string ToString()
        {
            ...
            ExcepcionCasillerosEnBlanco miException = this;
            while (miException.InnerException != null)
            {
                miException = (ExcepcionCasillerosEnBlanco)miException.InnerException;
