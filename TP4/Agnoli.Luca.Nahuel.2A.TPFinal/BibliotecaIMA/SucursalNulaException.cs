...
{
    public class SucursalNulaException :Exception
    {
        ...
        public SucursalNulaException(string mensaje, string clase, string metodo) : this(mensaje, clase, metodo, null)
        {
        }
        /// <summary>
        ...
        public SucursalNulaException(string mensaje, string clase, string metodo, Exception innerException)
        ...
        public override string ToString()
        {
            ...
            SucursalNulaException miException = this;
            while (miException.InnerException != null)
            {
                miException = (SucursalNulaException)miException.InnerException;
