...
namespace Entidades
{
    ...
    public sealed class Taller
    {
        ...
        public static Taller operator -(Taller t, Vehiculo vehiculo)
        {
            foreach (Vehiculo v in t.vehiculos)
            {
                if (v == vehiculo) //verificamos que el auto pertenezca al taller
                {
                    t.vehiculos.Remove(vehiculo); // eliminamos el vehiculo de la lista del taller
                    break;
                }
            }
